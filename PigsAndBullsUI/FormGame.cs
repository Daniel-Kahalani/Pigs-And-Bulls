...
//        private const int k_NumOfSpacesBetweenLetters = 1;
        ...
        //    for (int i = 0; i < GameLogic.k_GuessLength; i++)
        //    {
        //        for (int j = 1; j <= k_NumOfSpacesBetweenLetters; j++)
        //        {
        //            int userGuessSpaceIndex = ((k_NumOfSpacesBetweenLetters + 1) * i) + j;
        //            io_GuessCharArry[userGuessSpaceIndex] = k_EmptyCell;
        //        }
        //    }
        //}
        ...
        //    for (int column = 0; column < GameLogic.k_GuessLength; column++) 
        //    {
        //        int userGuessLetterIndex = (k_NumOfSpacesBetweenLetters + 1) * column;
